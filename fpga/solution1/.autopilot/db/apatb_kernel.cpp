...
extern "C"
void apatb_kernel_hw(void* __xlx_apatb_param_v, void* __xlx_apatb_param_convFPGA, void* __xlx_apatb_param_numIter)
{
  hls::sim::Byte<4> __xlx_offset_byte_param_v;
  ...
  port0.param = &__xlx_offset_byte_param_v;
  ...
  port3.param = { __xlx_apatb_param_v };
  port3.nbytes = { 2048 };
  port3.offset = {  };
  port3.hasWrite = { true };
  ...
  try {
    ...
    kernel_hw_stub_wrapper(__xlx_apatb_param_v, __xlx_apatb_param_convFPGA, __xlx_apatb_param_numIter);
