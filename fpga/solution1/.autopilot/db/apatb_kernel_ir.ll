...
entry:
  %v_copy = alloca [256 x double], align 512
  %convFPGA_copy = alloca [1 x i1], align 512
  %numIter_copy = alloca [1 x i32], align 512
  %0 = bitcast double* %v to [256 x double]*
  %1 = bitcast i1* %convFPGA to [1 x i1]*
  %2 = bitcast i32* %numIter to [1 x i32]*
  call fastcc void @copy_in([256 x double]* nonnull %0, [256 x double]* nonnull align 512 %v_copy, [1 x i1]* nonnull %1, [1 x i1]* nonnull align 512 %convFPGA_copy, [1 x i32]* nonnull %2, [1 x i32]* nonnull align 512 %numIter_copy)
  ...
  call void @apatb_kernel_hw([256 x double]* %v_copy, i1* %3, i32* %4)
  call void @copy_back([256 x double]* %0, [256 x double]* %v_copy, [1 x i1]* %1, [1 x i1]* %convFPGA_copy, [1 x i32]* %2, [1 x i32]* %numIter_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_in([256 x double]* noalias readonly, [256 x double]* noalias align 512, [1 x i1]* noalias readonly, [1 x i1]* noalias align 512, [1 x i32]* noalias readonly, [1 x i32]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([256 x double]* noalias, [256 x double]* noalias readonly align 512, [1 x i1]* noalias, [1 x i1]* noalias readonly align 512, [1 x i32]* noalias, [1 x i32]* noalias readonly align 512) unnamed_addr #4 {
entry:
...
declare void @apatb_kernel_hw([256 x double]*, i1*, i32*)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([256 x double]* noalias, [256 x double]* noalias readonly align 512, [1 x i1]* noalias, [1 x i1]* noalias readonly align 512, [1 x i32]* noalias, [1 x i32]* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256f64([256 x double]* %0, [256 x double]* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0a1i1([1 x i1]* %2, [1 x i1]* align 512 %3)
  call fastcc void @onebyonecpy_hls.p0a1i32([1 x i32]* %4, [1 x i32]* align 512 %5)
...
define void @kernel_hw_stub_wrapper([256 x double]*, i1*, i32*) #5 {
entry:
  %3 = bitcast i1* %1 to [1 x i1]*
  %4 = bitcast i32* %2 to [1 x i32]*
  call void @copy_out([256 x double]* null, [256 x double]* %0, [1 x i1]* null, [1 x i1]* %3, [1 x i32]* null, [1 x i32]* %4)
  %5 = bitcast [256 x double]* %0 to double*
  %6 = bitcast [1 x i1]* %3 to i1*
  %7 = bitcast [1 x i32]* %4 to i32*
  call void @kernel_hw_stub(double* %5, i1* %6, i32* %7)
  call void @copy_in([256 x double]* null, [256 x double]* %0, [1 x i1]* null, [1 x i1]* %3, [1 x i32]* null, [1 x i32]* %4)
  ret void
}
