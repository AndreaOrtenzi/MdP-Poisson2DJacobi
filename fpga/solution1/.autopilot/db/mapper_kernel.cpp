...
using hls::sim::Byte;
extern "C" void kernel(Byte<8>*, Byte<4>*, int, int, int);
extern "C" void apatb_kernel_hw(volatile void * __xlx_apatb_param_v, volatile void * __xlx_apatb_param_convFPGA, volatile void * __xlx_apatb_param_numIter) {
...
__xlx_convFPGA_numIter__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_numIter)[i]);
  ...
  // DUT call
  kernel(__xlx_v__tmp_vec.data(), __xlx_convFPGA_numIter__tmp_vec.data(), __xlx_offset_byte_param_v, __xlx_offset_byte_param_convFPGA, __xlx_offset_byte_param_numIter);
