...
extern "C" void kernel(Byte<64>*, Byte<4>*, int, int, int);
extern "C" void apatb_kernel_hw(volatile void * __xlx_apatb_param_v_out, volatile void * __xlx_apatb_param_convFPGA, volatile void * __xlx_apatb_param_numIter) {
using hls::sim::createStream;
  // Collect __xlx_v_out__tmp_vec
std::vector<Byte<64>> __xlx_v_out__tmp_vec;
for (size_t i = 0; i < 16; ++i){
__xlx_v_out__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_v_out)[i]);
}
  int __xlx_size_param_v_out = 16;
  int __xlx_offset_param_v_out = 0;
  int __xlx_offset_byte_param_v_out = 0*64;
  // Collect __xlx_convFPGA_numIter__tmp_vec
std::vector<Byte<4>> __xlx_convFPGA_numIter__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_convFPGA_numIter__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_convFPGA)[i]);
}
  int __xlx_size_param_convFPGA = 1;
  int __xlx_offset_param_convFPGA = 0;
  int __xlx_offset_byte_param_convFPGA = 0*4;
for (size_t i = 0; i < 1; ++i){
__xlx_convFPGA_numIter__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_numIter)[i]);
}
  int __xlx_size_param_numIter = 1;
  int __xlx_offset_param_numIter = 1;
  int __xlx_offset_byte_param_numIter = 1*4;
  // DUT call
  kernel(__xlx_v_out__tmp_vec.data(), __xlx_convFPGA_numIter__tmp_vec.data(), __xlx_offset_byte_param_v_out, __xlx_offset_byte_param_convFPGA, __xlx_offset_byte_param_numIter);
// print __xlx_apatb_param_v_out
for (size_t i = 0; i < __xlx_size_param_v_out; ++i) {
((Byte<64>*)__xlx_apatb_param_v_out)[i] = __xlx_v_out__tmp_vec[__xlx_offset_param_v_out+i];
}
// print __xlx_apatb_param_convFPGA
for (size_t i = 0; i < __xlx_size_param_convFPGA; ++i) {
((Byte<4>*)__xlx_apatb_param_convFPGA)[i] = __xlx_convFPGA_numIter__tmp_vec[__xlx_offset_param_convFPGA+i];
}
// print __xlx_apatb_param_numIter
for (size_t i = 0; i < __xlx_size_param_numIter; ++i) {
((Byte<4>*)__xlx_apatb_param_numIter)[i] = __xlx_convFPGA_numIter__tmp_vec[__xlx_offset_param_numIter+i];
}
}
