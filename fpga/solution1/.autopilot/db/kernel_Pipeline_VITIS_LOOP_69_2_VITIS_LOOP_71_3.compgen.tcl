...
set name kernel_dcmp_64ns_64ns_1_2_no_dsp_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_kernel_Pipeline_VITIS_LOOP_69_2_VITIS_LOOP_71_3_f_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename vp \
    op interface \
    ports { vp_address0 { O 8 vector } vp_ce0 { O 1 bit } vp_we0 { O 1 bit } vp_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'vp'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_e_2_out \
    op interface \
    ports { e_2_out { O 64 vector } e_2_out_ap_vld { O 1 bit } } \
} "
}
