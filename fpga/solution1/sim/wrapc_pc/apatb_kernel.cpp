...
// wrapc file define:
#define AUTOTB_TVIN_v_out "../tv/cdatafile/c.kernel.autotvin_v_out.dat"
#define AUTOTB_TVOUT_v_out "../tv/cdatafile/c.kernel.autotvout_v_out.dat"
#define AUTOTB_TVIN_convFPGA "../tv/cdatafile/c.kernel.autotvin_convFPGA.dat"
#define AUTOTB_TVOUT_convFPGA "../tv/cdatafile/c.kernel.autotvout_convFPGA.dat"
#define AUTOTB_TVIN_numIter "../tv/cdatafile/c.kernel.autotvin_numIter.dat"
#define AUTOTB_TVOUT_numIter "../tv/cdatafile/c.kernel.autotvout_numIter.dat"
...
extern "C"
void apatb_kernel_hw(void* __xlx_apatb_param_v_out, void* __xlx_apatb_param_convFPGA, void* __xlx_apatb_param_numIter)
{
  hls::sim::Byte<4> __xlx_offset_byte_param_v_out;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_v_out),
#endif
  };
  port0.param = &__xlx_offset_byte_param_v_out;

  hls::sim::Byte<4> __xlx_offset_byte_param_convFPGA;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_convFPGA),
#endif
  };
  port1.param = &__xlx_offset_byte_param_convFPGA;

  hls::sim::Byte<4> __xlx_offset_byte_param_numIter;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_numIter),
#endif
  };
  port2.param = &__xlx_offset_byte_param_numIter;
  ...
  port3.param = { __xlx_apatb_param_v_out };
  port3.nbytes = { 1024 };
  port3.offset = {  };
  port3.hasWrite = { true };
  ...
  __xlx_offset_byte_param_convFPGA = 0*4;
  __xlx_offset_byte_param_numIter = 1*4;
  port4.param = { __xlx_apatb_param_convFPGA, __xlx_apatb_param_numIter };
  port4.nbytes = { 1, 4 };
  port4.offset = { 0, 1 };
  ...
  try {
    ...
    kernel_hw_stub_wrapper(__xlx_apatb_param_v_out, __xlx_apatb_param_convFPGA, __xlx_apatb_param_numIter);
